      ...
      <div className="bg-[#F7F7F8] w-[100vw] h-[100vw] ">
        <div className="bg-[#FFFFFF] ">
          ...
          <div className="py-2 flex gap-4 px-4">
            ...
            <p className="text-[#121316] font-normal text-base">Бүтээгдэхүүн нэмэх</p>
          </div>
          </Link>
        </div>
            ...
            <div className="bg-[#FFFFFF] rounded-xl h-[228px]">
              <div className="pt-6 pl-6">
                ...
                <div className="flex gap-6 items-center pt-2">
                  <h2 className="text-[#000000] font-normal text-sm ">
                    Хэмжээ
                  </h2>
                  <Button className=" bg-[#ECEDF0] rounded-full py-1 px-1 w-6 h-6 ">
                    <Plus color="black" size={20} />
                ...
                <div className="py-6">
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button variant="outline" className="text-[#121316]">
                        Төрөл нэмэх
                      </Button>
                    </PopoverTrigger>
